        ...
        <div className="App">
            <div className="section" id="section1">
                <h1 className='headline'>
                    <span className='main-headline'>Provide better cell coverage to your business</span> <br /> And get a <span className='underline'>free internet line</span> for it!<br /> Here's how you benefit:
                </h1>
